...
interface ConnectionFavoritePayload {
  version: 1;
...
interface DatabaseObjectFavoritePayload {
  version: 1;
...
type FavoritePayload = SqlFavoritePayload | ConnectionFavoritePayload | DatabaseObjectFavoritePayload;
